...
const About = () => {
  return (
    <section
      id="about"
      className="min-h-screen flex flex-col justify-center items-center px-4 sm:px-5 md:px-10 lg:px-20"
    >
      <h1 className="sectionTitle text-secondary">
        About <span className="text-primary">Me</span>
      </h1>

      <div className="flex gap-10 items-center mt-15">
        <div className="flex-1 flex flex-col gap-5">
          ...
          <div className="flex flex-col md:flex-row items-center gap-5 mt-5">
            <button className="flex-1 btnBg font-semibold px-5 py-2 rounded-full cursor-pointer">
              Stay In Touch
            </button>
            <button className="flex-1 btnBg font-semibold px-5 py-2 rounded-full cursor-pointer">
              Download CV
        ...
        <div className="flex-1 flex flex-col gap-5">
          <div className="bgCard p-6 flex  items-center gap-5">
